        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
                ...
                <p class="text-white/60 text-sm leading-relaxed">
                    Snaga jadranske bure. Treniramo judo za sve uzraste u prijateljskom okruženju s naglaskom na disciplinu, poštovanje i zajedništvo.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-white/60 text-sm"><br>23248, Ljubač</span>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:+4915255317924" class="text-white/60 hover:text-bura-400 transition-colors text-sm">+4915255317924</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="size-5 text-bura-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
